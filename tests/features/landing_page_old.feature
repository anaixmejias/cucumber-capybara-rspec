Feature: Viewer visits the Home Page
  ...
  Scenario: Success Fill out form
    ...
    And I click "Sign in"
    Then I should see "Welcome! Hi there, John Doe. You'll new receive our email newsletter at john@doe.com"
  ...
  Scenario: Error Fill out form
    ...
    And I fill in "Email" with "john@doe.com"
    And I click "Sign in"
    Then I should see "Error! Hi there, John Doe. You have to enter all the fields."
